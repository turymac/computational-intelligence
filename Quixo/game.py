...
class Game(object):
    ...
    def print(self):
        ...
        emoji=['\U00000030','\U00000031','\U00000032','\U00000033','\U00000034']
        for r in range(5):
            print(emoji[r],end='  ')
            for c in range(5):
                if board[r][c] == -1:
                    ...
                    print('\U0000274C',end=' ') #CROSS MARK
                elif board[r][c] == 1:
                    print('\U00002B55',end=' ') #CIRCLE MARK
                else:
                    raise "Tiles must be mapped to either -1, 0 or 1"
            print()
    ...
    def play(self, player1: Player, player2: Player) -> int:
        ...
        while winner < 0:
            ...
            print(f"Slide {from_pos} to {slide}:")
            self.print()
            print()
